...
The prompts are intended to help jump-start your ideation process. If you would like to edit a problem (for example, picking a different data source) or combine multiple prompts together, you may do that as well! **Consult your lead instructor(s) for final approval before getting started.**
...
For the next three weeks, our class will tackle various projects related to emergency preparedness and economic analysis. On **September 18th**, you'll present your findings and deliver:
