...
- **Due**: Friday 9/4, lightning talks to follow the quiz
...
- **Due**: EOD on Wednesday 9/16 _(1:1s to begin the following Monday 9/21 - sign up [here](https://docs.google.com/spreadsheets/d/173ROKfp_VEQVopMPHaqKsujCFBWG-dmkjH5YT_7t67M/edit?usp=sharing))_
